...
<?php 
    ...
    wp_enqueue_style('wit-styleCss-country', get_template_directory_uri(). '/landing-assets/country-select/build/css/countrySelect.css');
    wp_enqueue_style('wit-styleCss', get_template_directory_uri(). '/landing-assets/dist/css/style.css');
?>
<?php wp_head();?>
</head>
<body>
